...
namespace TIN_Project.Server.Services.RepertoiresServices
{
    public interface IRepertoiresDbService
    {
        ...
        public Task AddRepertoireForCinemaAsync(int idCinema, Repertoire repertoire);
        ...
        public Task<List<Repertoire>> GetRepertoiresByMoviesRepertoiresAsync(List<MovieRepertoire> movieRepertoires);
    }
}
