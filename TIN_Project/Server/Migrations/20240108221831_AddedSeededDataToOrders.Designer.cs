...
namespace TIN_Project.Server.Migrations
{
    ...
    [Migration("20240108221831_AddedSeededDataToOrders")]
    partial class AddedSeededDataToOrders
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TIN_Project.Server.Models.MovieRepertoire", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdMovie = 1,
                            IdRepertoire = 1,
                            ShowTime = new TimeOnly(0, 18, 31, 665).Add(TimeSpan.FromTicks(5318))
                        },
                        new
                        {
                            IdMovieRepertoire = 2,
                            IdMovie = 2,
                            IdRepertoire = 1,
                            ShowTime = new TimeOnly(1, 18, 31, 665).Add(TimeSpan.FromTicks(5389))
                        },
                        new
                        {
                            IdMovieRepertoire = 3,
                            IdMovie = 3,
                            IdRepertoire = 1,
                            ShowTime = new TimeOnly(2, 18, 31, 665).Add(TimeSpan.FromTicks(5392))
                        },
                        new
                        {
                            IdMovieRepertoire = 4,
                            IdMovie = 4,
                            IdRepertoire = 1,
                            ShowTime = new TimeOnly(3, 18, 31, 665).Add(TimeSpan.FromTicks(5394))
                        },
                        new
                        {
                            IdMovieRepertoire = 5,
                            IdMovie = 5,
                            IdRepertoire = 2,
                            ShowTime = new TimeOnly(0, 18, 31, 665).Add(TimeSpan.FromTicks(5396))
                        },
                        new
                        {
                            IdMovieRepertoire = 6,
                            IdMovie = 6,
                            IdRepertoire = 2,
                            ShowTime = new TimeOnly(1, 18, 31, 665).Add(TimeSpan.FromTicks(5398))
                        },
                        new
                        {
                            IdMovieRepertoire = 7,
                            IdMovie = 7,
                            IdRepertoire = 2,
                            ShowTime = new TimeOnly(2, 18, 31, 665).Add(TimeSpan.FromTicks(5401))
                        },
                        new
                        {
                            IdMovieRepertoire = 8,
                            IdMovie = 1,
                            IdRepertoire = 2,
                            ShowTime = new TimeOnly(3, 18, 31, 665).Add(TimeSpan.FromTicks(5402))
                        },
                        new
                        {
                            IdMovieRepertoire = 9,
                            IdMovie = 2,
                            IdRepertoire = 3,
                            ShowTime = new TimeOnly(0, 18, 31, 665).Add(TimeSpan.FromTicks(5404))
                        },
                        new
                        {
                            ...
                            IdMovie = 3,
                            IdRepertoire = 3,
                            ShowTime = new TimeOnly(1, 18, 31, 665).Add(TimeSpan.FromTicks(5407))
                        },
                        new
                        {
                            ...
                            IdMovie = 4,
                            IdRepertoire = 3,
                            ShowTime = new TimeOnly(2, 18, 31, 665).Add(TimeSpan.FromTicks(5409))
                        },
                        new
                        {
                            ...
                            IdMovie = 5,
                            IdRepertoire = 3,
                            ShowTime = new TimeOnly(3, 18, 31, 665).Add(TimeSpan.FromTicks(5410))
                        },
                        new
                        {
                            ...
                            IdMovie = 6,
                            IdRepertoire = 4,
                            ShowTime = new TimeOnly(0, 18, 31, 665).Add(TimeSpan.FromTicks(5412))
                        },
                        new
                        {
                            ...
                            IdMovie = 7,
                            IdRepertoire = 4,
                            ShowTime = new TimeOnly(1, 18, 31, 665).Add(TimeSpan.FromTicks(5414))
                        },
                        new
                        {
                            ...
                            IdMovie = 1,
                            IdRepertoire = 4,
                            ShowTime = new TimeOnly(2, 18, 31, 665).Add(TimeSpan.FromTicks(5416))
                        },
                        new
                        {
                            ...
                            IdMovie = 2,
                            IdRepertoire = 4,
                            ShowTime = new TimeOnly(3, 18, 31, 665).Add(TimeSpan.FromTicks(5418))
                        },
                        new
                        {
                            ...
                            IdMovie = 3,
                            IdRepertoire = 5,
                            ShowTime = new TimeOnly(0, 18, 31, 665).Add(TimeSpan.FromTicks(5420))
                        },
                        new
                        {
                            ...
                            IdMovie = 4,
                            IdRepertoire = 5,
                            ShowTime = new TimeOnly(1, 18, 31, 665).Add(TimeSpan.FromTicks(5422))
                        },
                        new
                        {
                            ...
                            IdMovie = 5,
                            IdRepertoire = 5,
                            ShowTime = new TimeOnly(2, 18, 31, 665).Add(TimeSpan.FromTicks(5424))
                        },
                        new
                        {
                            ...
                            IdMovie = 6,
                            IdRepertoire = 5,
                            ShowTime = new TimeOnly(3, 18, 31, 665).Add(TimeSpan.FromTicks(5426))
                        },
                        new
                        {
                            ...
                            IdMovie = 7,
                            IdRepertoire = 6,
                            ShowTime = new TimeOnly(0, 18, 31, 665).Add(TimeSpan.FromTicks(5428))
                        },
                        new
                        {
                            ...
                            IdMovie = 1,
                            IdRepertoire = 6,
                            ShowTime = new TimeOnly(1, 18, 31, 665).Add(TimeSpan.FromTicks(5430))
                        },
                        new
                        {
                            ...
                            IdMovie = 2,
                            IdRepertoire = 6,
                            ShowTime = new TimeOnly(2, 18, 31, 665).Add(TimeSpan.FromTicks(5432))
                        },
                        new
                        {
                            ...
                            IdMovie = 3,
                            IdRepertoire = 6,
                            ShowTime = new TimeOnly(3, 18, 31, 665).Add(TimeSpan.FromTicks(5434))
                        },
                        new
                        {
                            ...
                            IdMovie = 4,
                            IdRepertoire = 7,
                            ShowTime = new TimeOnly(0, 18, 31, 665).Add(TimeSpan.FromTicks(5436))
                        },
                        new
                        {
                            ...
                            IdMovie = 5,
                            IdRepertoire = 7,
                            ShowTime = new TimeOnly(1, 18, 31, 665).Add(TimeSpan.FromTicks(5438))
                        },
                        new
                        {
                            ...
                            IdMovie = 6,
                            IdRepertoire = 7,
                            ShowTime = new TimeOnly(2, 18, 31, 665).Add(TimeSpan.FromTicks(5440))
                        },
                        new
                        {
                            ...
                            IdMovie = 7,
                            IdRepertoire = 7,
                            ShowTime = new TimeOnly(3, 18, 31, 665).Add(TimeSpan.FromTicks(5442))
                        },
                        new
                        {
                            ...
                            IdMovie = 1,
                            IdRepertoire = 8,
                            ShowTime = new TimeOnly(0, 18, 31, 665).Add(TimeSpan.FromTicks(5444))
                        },
                        new
                        {
                            ...
                            IdMovie = 2,
                            IdRepertoire = 8,
                            ShowTime = new TimeOnly(1, 18, 31, 665).Add(TimeSpan.FromTicks(5446))
                        },
                        new
                        {
                            ...
                            IdMovie = 3,
                            IdRepertoire = 8,
                            ShowTime = new TimeOnly(2, 18, 31, 665).Add(TimeSpan.FromTicks(5448))
                        },
                        new
                        {
                            ...
                            IdMovie = 4,
                            IdRepertoire = 8,
                            ShowTime = new TimeOnly(3, 18, 31, 665).Add(TimeSpan.FromTicks(5450))
                        },
                        new
                        {
                            ...
                            IdMovie = 5,
                            IdRepertoire = 9,
                            ShowTime = new TimeOnly(0, 18, 31, 665).Add(TimeSpan.FromTicks(5452))
                        },
                        new
                        {
                            ...
                            IdMovie = 6,
                            IdRepertoire = 9,
                            ShowTime = new TimeOnly(1, 18, 31, 665).Add(TimeSpan.FromTicks(5453))
                        },
                        new
                        {
                            ...
                            IdMovie = 7,
                            IdRepertoire = 9,
                            ShowTime = new TimeOnly(2, 18, 31, 665).Add(TimeSpan.FromTicks(5455))
                        },
                        new
                        {
                            ...
                            IdMovie = 1,
                            IdRepertoire = 9,
                            ShowTime = new TimeOnly(3, 18, 31, 665).Add(TimeSpan.FromTicks(5457))
                        },
                        new
                        {
                            ...
                            IdMovie = 2,
                            IdRepertoire = 10,
                            ShowTime = new TimeOnly(0, 18, 31, 665).Add(TimeSpan.FromTicks(5459))
                        },
                        new
                        {
                            ...
                            IdMovie = 3,
                            IdRepertoire = 10,
                            ShowTime = new TimeOnly(1, 18, 31, 665).Add(TimeSpan.FromTicks(5461))
                        },
                        new
                        {
                            ...
                            IdMovie = 4,
                            IdRepertoire = 10,
                            ShowTime = new TimeOnly(2, 18, 31, 665).Add(TimeSpan.FromTicks(5463))
                        },
                        new
                        {
                            ...
                            IdMovie = 5,
                            IdRepertoire = 10,
                            ShowTime = new TimeOnly(3, 18, 31, 665).Add(TimeSpan.FromTicks(5465))
                        },
                        new
                        {
                            ...
                            IdMovie = 6,
                            IdRepertoire = 11,
                            ShowTime = new TimeOnly(0, 18, 31, 665).Add(TimeSpan.FromTicks(5467))
                        },
                        new
                        {
                            ...
                            IdMovie = 7,
                            IdRepertoire = 11,
                            ShowTime = new TimeOnly(1, 18, 31, 665).Add(TimeSpan.FromTicks(5469))
                        });
                });
