...
namespace TIN_Project.Server.Migrations
{
    ...
    [Migration("20240101230714_AddedSuperuserToDatabase")]
    partial class AddedSuperuserToDatabase
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TIN_Project.Server.Models.MovieRepertoire", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdMovie = 1,
                            IdRepertoire = 1,
                            ShowTime = new TimeOnly(1, 7, 14, 56).Add(TimeSpan.FromTicks(6311))
                        },
                        new
                        {
                            IdMovieRepertoire = 2,
                            IdMovie = 2,
                            IdRepertoire = 1,
                            ShowTime = new TimeOnly(2, 7, 14, 56).Add(TimeSpan.FromTicks(6391))
                        },
                        new
                        {
                            IdMovieRepertoire = 3,
                            IdMovie = 3,
                            IdRepertoire = 1,
                            ShowTime = new TimeOnly(3, 7, 14, 56).Add(TimeSpan.FromTicks(6394))
                        },
                        new
                        {
                            IdMovieRepertoire = 4,
                            IdMovie = 4,
                            IdRepertoire = 1,
                            ShowTime = new TimeOnly(4, 7, 14, 56).Add(TimeSpan.FromTicks(6396))
                        },
                        new
                        {
                            IdMovieRepertoire = 5,
                            IdMovie = 5,
                            IdRepertoire = 2,
                            ShowTime = new TimeOnly(1, 7, 14, 56).Add(TimeSpan.FromTicks(6399))
                        },
                        new
                        {
                            IdMovieRepertoire = 6,
                            IdMovie = 6,
                            IdRepertoire = 2,
                            ShowTime = new TimeOnly(2, 7, 14, 56).Add(TimeSpan.FromTicks(6401))
                        },
                        new
                        {
                            IdMovieRepertoire = 7,
                            IdMovie = 7,
                            IdRepertoire = 2,
                            ShowTime = new TimeOnly(3, 7, 14, 56).Add(TimeSpan.FromTicks(6403))
                        },
                        new
                        {
                            IdMovieRepertoire = 8,
                            IdMovie = 1,
                            IdRepertoire = 2,
                            ShowTime = new TimeOnly(4, 7, 14, 56).Add(TimeSpan.FromTicks(6407))
                        },
                        new
                        {
                            IdMovieRepertoire = 9,
                            IdMovie = 2,
                            IdRepertoire = 3,
                            ShowTime = new TimeOnly(1, 7, 14, 56).Add(TimeSpan.FromTicks(6409))
                        },
                        new
                        {
                            ...
                            IdMovie = 3,
                            IdRepertoire = 3,
                            ShowTime = new TimeOnly(2, 7, 14, 56).Add(TimeSpan.FromTicks(6412))
                        },
                        new
                        {
                            ...
                            IdMovie = 4,
                            IdRepertoire = 3,
                            ShowTime = new TimeOnly(3, 7, 14, 56).Add(TimeSpan.FromTicks(6414))
                        },
                        new
                        {
                            ...
                            IdMovie = 5,
                            IdRepertoire = 3,
                            ShowTime = new TimeOnly(4, 7, 14, 56).Add(TimeSpan.FromTicks(6416))
                        },
                        new
                        {
                            ...
                            IdMovie = 6,
                            IdRepertoire = 4,
                            ShowTime = new TimeOnly(1, 7, 14, 56).Add(TimeSpan.FromTicks(6419))
                        },
                        new
                        {
                            ...
                            IdMovie = 7,
                            IdRepertoire = 4,
                            ShowTime = new TimeOnly(2, 7, 14, 56).Add(TimeSpan.FromTicks(6422))
                        },
                        new
                        {
                            ...
                            IdMovie = 1,
                            IdRepertoire = 4,
                            ShowTime = new TimeOnly(3, 7, 14, 56).Add(TimeSpan.FromTicks(6424))
                        },
                        new
                        {
                            ...
                            IdMovie = 2,
                            IdRepertoire = 4,
                            ShowTime = new TimeOnly(4, 7, 14, 56).Add(TimeSpan.FromTicks(6426))
                        },
                        new
                        {
                            ...
                            IdMovie = 3,
                            IdRepertoire = 5,
                            ShowTime = new TimeOnly(1, 7, 14, 56).Add(TimeSpan.FromTicks(6429))
                        },
                        new
                        {
                            ...
                            IdMovie = 4,
                            IdRepertoire = 5,
                            ShowTime = new TimeOnly(2, 7, 14, 56).Add(TimeSpan.FromTicks(6431))
                        },
                        new
                        {
                            ...
                            IdMovie = 5,
                            IdRepertoire = 5,
                            ShowTime = new TimeOnly(3, 7, 14, 56).Add(TimeSpan.FromTicks(6433))
                        },
                        new
                        {
                            ...
                            IdMovie = 6,
                            IdRepertoire = 5,
                            ShowTime = new TimeOnly(4, 7, 14, 56).Add(TimeSpan.FromTicks(6436))
                        },
                        new
                        {
                            ...
                            IdMovie = 7,
                            IdRepertoire = 6,
                            ShowTime = new TimeOnly(1, 7, 14, 56).Add(TimeSpan.FromTicks(6439))
                        },
                        new
                        {
                            ...
                            IdMovie = 1,
                            IdRepertoire = 6,
                            ShowTime = new TimeOnly(2, 7, 14, 56).Add(TimeSpan.FromTicks(6442))
                        },
                        new
                        {
                            ...
                            IdMovie = 2,
                            IdRepertoire = 6,
                            ShowTime = new TimeOnly(3, 7, 14, 56).Add(TimeSpan.FromTicks(6444))
                        },
                        new
                        {
                            ...
                            IdMovie = 3,
                            IdRepertoire = 6,
                            ShowTime = new TimeOnly(4, 7, 14, 56).Add(TimeSpan.FromTicks(6447))
                        },
                        new
                        {
                            ...
                            IdMovie = 4,
                            IdRepertoire = 7,
                            ShowTime = new TimeOnly(1, 7, 14, 56).Add(TimeSpan.FromTicks(6449))
                        },
                        new
                        {
                            ...
                            IdMovie = 5,
                            IdRepertoire = 7,
                            ShowTime = new TimeOnly(2, 7, 14, 56).Add(TimeSpan.FromTicks(6453))
                        },
                        new
                        {
                            ...
                            IdMovie = 6,
                            IdRepertoire = 7,
                            ShowTime = new TimeOnly(3, 7, 14, 56).Add(TimeSpan.FromTicks(6455))
                        },
                        new
                        {
                            ...
                            IdMovie = 7,
                            IdRepertoire = 7,
                            ShowTime = new TimeOnly(4, 7, 14, 56).Add(TimeSpan.FromTicks(6458))
                        },
                        new
                        {
                            ...
                            IdMovie = 1,
                            IdRepertoire = 8,
                            ShowTime = new TimeOnly(1, 7, 14, 56).Add(TimeSpan.FromTicks(6461))
                        },
                        new
                        {
                            ...
                            IdMovie = 2,
                            IdRepertoire = 8,
                            ShowTime = new TimeOnly(2, 7, 14, 56).Add(TimeSpan.FromTicks(6463))
                        },
                        new
                        {
                            ...
                            IdMovie = 3,
                            IdRepertoire = 8,
                            ShowTime = new TimeOnly(3, 7, 14, 56).Add(TimeSpan.FromTicks(6466))
                        },
                        new
                        {
                            ...
                            IdMovie = 4,
                            IdRepertoire = 8,
                            ShowTime = new TimeOnly(4, 7, 14, 56).Add(TimeSpan.FromTicks(6468))
                        },
                        new
                        {
                            ...
                            IdMovie = 5,
                            IdRepertoire = 9,
                            ShowTime = new TimeOnly(1, 7, 14, 56).Add(TimeSpan.FromTicks(6471))
                        },
                        new
                        {
                            ...
                            IdMovie = 6,
                            IdRepertoire = 9,
                            ShowTime = new TimeOnly(2, 7, 14, 56).Add(TimeSpan.FromTicks(6474))
                        },
                        new
                        {
                            ...
                            IdMovie = 7,
                            IdRepertoire = 9,
                            ShowTime = new TimeOnly(3, 7, 14, 56).Add(TimeSpan.FromTicks(6478))
                        },
                        new
                        {
                            ...
                            IdMovie = 1,
                            IdRepertoire = 9,
                            ShowTime = new TimeOnly(4, 7, 14, 56).Add(TimeSpan.FromTicks(6480))
                        },
                        new
                        {
                            ...
                            IdMovie = 2,
                            IdRepertoire = 10,
                            ShowTime = new TimeOnly(1, 7, 14, 56).Add(TimeSpan.FromTicks(6483))
                        },
                        new
                        {
                            ...
                            IdMovie = 3,
                            IdRepertoire = 10,
                            ShowTime = new TimeOnly(2, 7, 14, 56).Add(TimeSpan.FromTicks(6485))
                        },
                        new
                        {
                            ...
                            IdMovie = 4,
                            IdRepertoire = 10,
                            ShowTime = new TimeOnly(3, 7, 14, 56).Add(TimeSpan.FromTicks(6488))
                        },
                        new
                        {
                            ...
                            IdMovie = 5,
                            IdRepertoire = 10,
                            ShowTime = new TimeOnly(4, 7, 14, 56).Add(TimeSpan.FromTicks(6490))
                        },
                        new
                        {
                            ...
                            IdMovie = 6,
                            IdRepertoire = 11,
                            ShowTime = new TimeOnly(1, 7, 14, 56).Add(TimeSpan.FromTicks(6492))
                        },
                        new
                        {
                            ...
                            IdMovie = 7,
                            IdRepertoire = 11,
                            ShowTime = new TimeOnly(2, 7, 14, 56).Add(TimeSpan.FromTicks(6494))
                        });
                });
