...
namespace TIN_Project.Server.Migrations
{
    ...
    [Migration("20231231170556_AddedAdminToDatabase")]
    partial class AddedAdminToDatabase
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TIN_Project.Server.Models.MovieRepertoire", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdMovie = 1,
                            IdRepertoire = 1,
                            ShowTime = new TimeOnly(19, 5, 55, 967).Add(TimeSpan.FromTicks(5083))
                        },
                        new
                        {
                            IdMovieRepertoire = 2,
                            IdMovie = 2,
                            IdRepertoire = 1,
                            ShowTime = new TimeOnly(20, 5, 55, 967).Add(TimeSpan.FromTicks(5157))
                        },
                        new
                        {
                            IdMovieRepertoire = 3,
                            IdMovie = 3,
                            IdRepertoire = 1,
                            ShowTime = new TimeOnly(21, 5, 55, 967).Add(TimeSpan.FromTicks(5160))
                        },
                        new
                        {
                            IdMovieRepertoire = 4,
                            IdMovie = 4,
                            IdRepertoire = 1,
                            ShowTime = new TimeOnly(22, 5, 55, 967).Add(TimeSpan.FromTicks(5162))
                        },
                        new
                        {
                            IdMovieRepertoire = 5,
                            IdMovie = 5,
                            IdRepertoire = 2,
                            ShowTime = new TimeOnly(19, 5, 55, 967).Add(TimeSpan.FromTicks(5165))
                        },
                        new
                        {
                            IdMovieRepertoire = 6,
                            IdMovie = 6,
                            IdRepertoire = 2,
                            ShowTime = new TimeOnly(20, 5, 55, 967).Add(TimeSpan.FromTicks(5167))
                        },
                        new
                        {
                            IdMovieRepertoire = 7,
                            IdMovie = 7,
                            IdRepertoire = 2,
                            ShowTime = new TimeOnly(21, 5, 55, 967).Add(TimeSpan.FromTicks(5170))
                        },
                        new
                        {
                            IdMovieRepertoire = 8,
                            IdMovie = 1,
                            IdRepertoire = 2,
                            ShowTime = new TimeOnly(22, 5, 55, 967).Add(TimeSpan.FromTicks(5174))
                        },
                        new
                        {
                            IdMovieRepertoire = 9,
                            IdMovie = 2,
                            IdRepertoire = 3,
                            ShowTime = new TimeOnly(19, 5, 55, 967).Add(TimeSpan.FromTicks(5177))
                        },
                        new
                        {
                            ...
                            IdMovie = 3,
                            IdRepertoire = 3,
                            ShowTime = new TimeOnly(20, 5, 55, 967).Add(TimeSpan.FromTicks(5180))
                        },
                        new
                        {
                            ...
                            IdMovie = 4,
                            IdRepertoire = 3,
                            ShowTime = new TimeOnly(21, 5, 55, 967).Add(TimeSpan.FromTicks(5182))
                        },
                        new
                        {
                            ...
                            IdMovie = 5,
                            IdRepertoire = 3,
                            ShowTime = new TimeOnly(22, 5, 55, 967).Add(TimeSpan.FromTicks(5185))
                        },
                        new
                        {
                            ...
                            IdMovie = 6,
                            IdRepertoire = 4,
                            ShowTime = new TimeOnly(19, 5, 55, 967).Add(TimeSpan.FromTicks(5189))
                        },
                        new
                        {
                            ...
                            IdMovie = 7,
                            IdRepertoire = 4,
                            ShowTime = new TimeOnly(20, 5, 55, 967).Add(TimeSpan.FromTicks(5192))
                        },
                        new
                        {
                            ...
                            IdMovie = 1,
                            IdRepertoire = 4,
                            ShowTime = new TimeOnly(21, 5, 55, 967).Add(TimeSpan.FromTicks(5194))
                        },
                        new
                        {
                            ...
                            IdMovie = 2,
                            IdRepertoire = 4,
                            ShowTime = new TimeOnly(22, 5, 55, 967).Add(TimeSpan.FromTicks(5197))
                        },
                        new
                        {
                            ...
                            IdMovie = 3,
                            IdRepertoire = 5,
                            ShowTime = new TimeOnly(19, 5, 55, 967).Add(TimeSpan.FromTicks(5199))
                        },
                        new
                        {
                            ...
                            IdMovie = 4,
                            IdRepertoire = 5,
                            ShowTime = new TimeOnly(20, 5, 55, 967).Add(TimeSpan.FromTicks(5201))
                        },
                        new
                        {
                            ...
                            IdMovie = 5,
                            IdRepertoire = 5,
                            ShowTime = new TimeOnly(21, 5, 55, 967).Add(TimeSpan.FromTicks(5204))
                        },
                        new
                        {
                            ...
                            IdMovie = 6,
                            IdRepertoire = 5,
                            ShowTime = new TimeOnly(22, 5, 55, 967).Add(TimeSpan.FromTicks(5207))
                        },
                        new
                        {
                            ...
                            IdMovie = 7,
                            IdRepertoire = 6,
                            ShowTime = new TimeOnly(19, 5, 55, 967).Add(TimeSpan.FromTicks(5211))
                        },
                        new
                        {
                            ...
                            IdMovie = 1,
                            IdRepertoire = 6,
                            ShowTime = new TimeOnly(20, 5, 55, 967).Add(TimeSpan.FromTicks(5214))
                        },
                        new
                        {
                            ...
                            IdMovie = 2,
                            IdRepertoire = 6,
                            ShowTime = new TimeOnly(21, 5, 55, 967).Add(TimeSpan.FromTicks(5216))
                        },
                        new
                        {
                            ...
                            IdMovie = 3,
                            IdRepertoire = 6,
                            ShowTime = new TimeOnly(22, 5, 55, 967).Add(TimeSpan.FromTicks(5219))
                        },
                        new
                        {
                            ...
                            IdMovie = 4,
                            IdRepertoire = 7,
                            ShowTime = new TimeOnly(19, 5, 55, 967).Add(TimeSpan.FromTicks(5221))
                        },
                        new
                        {
                            ...
                            IdMovie = 5,
                            IdRepertoire = 7,
                            ShowTime = new TimeOnly(20, 5, 55, 967).Add(TimeSpan.FromTicks(5224))
                        },
                        new
                        {
                            ...
                            IdMovie = 6,
                            IdRepertoire = 7,
                            ShowTime = new TimeOnly(21, 5, 55, 967).Add(TimeSpan.FromTicks(5227))
                        },
                        new
                        {
                            ...
                            IdMovie = 7,
                            IdRepertoire = 7,
                            ShowTime = new TimeOnly(22, 5, 55, 967).Add(TimeSpan.FromTicks(5229))
                        },
                        new
                        {
                            ...
                            IdMovie = 1,
                            IdRepertoire = 8,
                            ShowTime = new TimeOnly(19, 5, 55, 967).Add(TimeSpan.FromTicks(5231))
                        },
                        new
                        {
                            ...
                            IdMovie = 2,
                            IdRepertoire = 8,
                            ShowTime = new TimeOnly(20, 5, 55, 967).Add(TimeSpan.FromTicks(5234))
                        },
                        new
                        {
                            ...
                            IdMovie = 3,
                            IdRepertoire = 8,
                            ShowTime = new TimeOnly(21, 5, 55, 967).Add(TimeSpan.FromTicks(5238))
                        },
                        new
                        {
                            ...
                            IdMovie = 4,
                            IdRepertoire = 8,
                            ShowTime = new TimeOnly(22, 5, 55, 967).Add(TimeSpan.FromTicks(5242))
                        },
                        new
                        {
                            ...
                            IdMovie = 5,
                            IdRepertoire = 9,
                            ShowTime = new TimeOnly(19, 5, 55, 967).Add(TimeSpan.FromTicks(5244))
                        },
                        new
                        {
                            ...
                            IdMovie = 6,
                            IdRepertoire = 9,
                            ShowTime = new TimeOnly(20, 5, 55, 967).Add(TimeSpan.FromTicks(5247))
                        },
                        new
                        {
                            ...
                            IdMovie = 7,
                            IdRepertoire = 9,
                            ShowTime = new TimeOnly(21, 5, 55, 967).Add(TimeSpan.FromTicks(5249))
                        },
                        new
                        {
                            ...
                            IdMovie = 1,
                            IdRepertoire = 9,
                            ShowTime = new TimeOnly(22, 5, 55, 967).Add(TimeSpan.FromTicks(5253))
                        },
                        new
                        {
                            ...
                            IdMovie = 2,
                            IdRepertoire = 10,
                            ShowTime = new TimeOnly(19, 5, 55, 967).Add(TimeSpan.FromTicks(5255))
                        },
                        new
                        {
                            ...
                            IdMovie = 3,
                            IdRepertoire = 10,
                            ShowTime = new TimeOnly(20, 5, 55, 967).Add(TimeSpan.FromTicks(5257))
                        },
                        new
                        {
                            ...
                            IdMovie = 4,
                            IdRepertoire = 10,
                            ShowTime = new TimeOnly(21, 5, 55, 967).Add(TimeSpan.FromTicks(5260))
                        },
                        new
                        {
                            ...
                            IdMovie = 5,
                            IdRepertoire = 10,
                            ShowTime = new TimeOnly(22, 5, 55, 967).Add(TimeSpan.FromTicks(5263))
                        },
                        new
                        {
                            ...
                            IdMovie = 6,
                            IdRepertoire = 11,
                            ShowTime = new TimeOnly(19, 5, 55, 967).Add(TimeSpan.FromTicks(5266))
                        },
                        new
                        {
                            ...
                            IdMovie = 7,
                            IdRepertoire = 11,
                            ShowTime = new TimeOnly(20, 5, 55, 967).Add(TimeSpan.FromTicks(5269))
                        });
                });
